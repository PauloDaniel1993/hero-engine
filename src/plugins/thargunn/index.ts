...
export const thargunnMythic: MechanicPlugin = {
  id: "thargunn-mythic", version: "1.0.6", archetype: "character",
  ...
  actions: [
    { id: "siphon-manual", labelKey: `${P}.Siphon.Action`, descriptionKey: `${P}.ActionDescriptions.Siphon`, runHook: true },
    { id: "field", labelKey: `${P}.Field.Action`, descriptionKey: `${P}.ActionDescriptions.Field`, runHook: true, cooldown: { type: "longRest" } },
    { id: "field-exit-save", labelKey: `${P}.Field.ExitAction`, descriptionKey: `${P}.ActionDescriptions.FieldExit`, requiresFlag: "fieldActive", requiresFlagReasonKey: `${P}.Availability.FieldInactive`, runHook: true },
    { id: "ultimate", labelKey: `${P}.Ultimate.Action`, descriptionKey: `${P}.ActionDescriptions.Ultimate`, requiresFlag: "ultimateReady", requiresFlagReasonKey: `${P}.Availability.UltimateRest`, forbidsFlag: "ultimateApprovalPending", forbidsFlagReasonKey: `${P}.Availability.ApprovalPending`, runHook: true, announceUse: false },
    { id: "rite", labelKey: `${P}.Rite.Action`, descriptionKey: `${P}.ActionDescriptions.Rite`, gmOnly: true, runHook: true },
    { id: "purify", labelKey: `${P}.Purification.Action`, descriptionKey: `${P}.ActionDescriptions.Purify`, gmOnly: true, runHook: true },
    { id: "skeldr-move", labelKey: `${P}.Ultimate.SkeldrMove`, descriptionKey: `${P}.ActionDescriptions.SkeldrMove`, costs: [{ resource: "legendaryPoints", amount: 1 }], requiresFlag: "ultimateActive", requiresFlagReasonKey: `${P}.Availability.UltimateInactive`, forbidsFlag: "ultimateTakeoverLocked", forbidsFlagReasonKey: `${P}.Availability.TakeoverLocked`, runHook: true },
    { id: "mighty-impel", labelKey: `${P}.Ultimate.MightyImpelAction`, descriptionKey: `${P}.ActionDescriptions.MightyImpel`, costs: [{ resource: "legendaryPoints", amount: 1 }], requiresFlag: "ultimateActive", requiresFlagReasonKey: `${P}.Availability.UltimateInactive`, forbidsFlag: "ultimateTakeoverLocked", forbidsFlagReasonKey: `${P}.Availability.TakeoverLocked`, runHook: true },
    { id: "devastating-strike", labelKey: `${P}.Ultimate.DevastatingStrike`, descriptionKey: `${P}.ActionDescriptions.DevastatingStrike`, costs: [{ resource: "legendaryPoints", amount: 2 }], requiresFlag: "ultimateActive", requiresFlagReasonKey: `${P}.Availability.UltimateInactive`, forbidsFlag: "ultimateTakeoverLocked", forbidsFlagReasonKey: `${P}.Availability.TakeoverLocked`, runHook: true },
    { id: "legendary-echo", labelKey: `${P}.Ultimate.LegendaryEcho`, descriptionKey: `${P}.ActionDescriptions.LegendaryEcho`, costs: [{ resource: "legendaryPoints", amount: 2 }], requiresFlag: "ultimateActive", requiresFlagReasonKey: `${P}.Availability.UltimateInactive`, forbidsFlag: "ultimateTakeoverLocked", forbidsFlagReasonKey: `${P}.Availability.TakeoverLocked`, runHook: true },
    { id: "second-siphon", labelKey: `${P}.Ultimate.SecondSiphon`, descriptionKey: `${P}.ActionDescriptions.SecondSiphon`, costs: [{ resource: "legendaryPoints", amount: 3 }], requiresFlag: "ultimateActive", requiresFlagReasonKey: `${P}.Availability.UltimateInactive`, forbidsFlag: "ultimateTakeoverLocked", forbidsFlagReasonKey: `${P}.Availability.TakeoverLocked`, runHook: true },
    { id: "skeldr-rescue", labelKey: `${P}.Ultimate.SkeldrRescue`, descriptionKey: `${P}.ActionDescriptions.SkeldrRescue`, costs: [{ resource: "legendaryPoints", amount: 3 }], requiresFlag: "ultimateActive", requiresFlagReasonKey: `${P}.Availability.UltimateInactive`, forbidsFlag: "ultimateTakeoverLocked", forbidsFlagReasonKey: `${P}.Availability.TakeoverLocked`, runHook: true },
    { id: "skeldr-hunger-guard", labelKey: `${P}.Skeldr.GuardAction`, descriptionKey: `${P}.ActionDescriptions.HungerGuard`, requiresFlag: "skeldrPresent", requiresFlagReasonKey: `${P}.Availability.SkeldrAbsent`, forbidsFlag: "skeldrHungerGuardUsed", forbidsFlagReasonKey: `${P}.Availability.GuardSpent`, runHook: true },
    { id: "skeldr-early-return", labelKey: `${P}.Skeldr.EarlyReturn`, descriptionKey: `${P}.ActionDescriptions.EarlyReturn`, forbidsFlag: "skeldrPresent", forbidsFlagReasonKey: `${P}.Availability.SkeldrPresent`, gmOnly: true, runHook: true },
    { id: "record-legend", labelKey: `${P}.Legends.Add`, descriptionKey: `${P}.ActionDescriptions.RecordLegend`, gmOnly: true, runHook: true },
  ],
